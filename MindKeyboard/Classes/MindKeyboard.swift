...
public final class MindKeyboard {
    
    static let `default` = MindKeyboard()
...
extension MindKeyboard: KeyboardCompletionProtocol {
...
public extension UIViewController {
    ...
    func addKeyboardObserver(_ completion: @escaping (Bool, CGFloat) -> Void) {
        MindKeyboard.default.addKeyboardObserver(for: self, completion)
    }
    
    func removeKeyboardObserver() {
        MindKeyboard.default.removeKeyboardObserver(for: self)
    }
